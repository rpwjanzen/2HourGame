...
{
    class GoldView : DrawableGameComponent
    {
        ...
        public GoldView(Game game, IEnumerable<Island> islands, IEnumerable<Ship> ships, SpriteBatch spriteBatch, float zIndex)
            : base(game)
        {
        ...
        {
            texture = this.Game.Content.Load<Texture2D>("gold");
        ...
        public override void Draw(GameTime gameTime)
        {
            foreach (Island island in islands) 
            {
                ...
                {
                    spriteBatch.Draw(texture, island.Position + goldIslandOffset + goldLocation(i) , null, Color.White, 0, origin, scale, SpriteEffects.None, zIndex);
                }
            }
