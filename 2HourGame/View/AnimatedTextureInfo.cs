...
{
    internal class AnimatedTextureInfo
    {
        /// <summary>
        ...
        public AnimatedTextureInfo(Vector2 imageSize, int totalFrames, double framesPerSecond, float scale,
                                   int numAnimationIterations, Vector2 offset, string contentName)
        {
            WindowSize = imageSize;
            TotalFrames = totalFrames;
            FramesPerSecond = framesPerSecond;
            Scale = scale;
            NumAnimationIterations = numAnimationIterations;
            this.offset = offset;
        ...
        {
            get { return new Vector2(WindowSize.X/2f, WindowSize.Y/2f); }
        }
